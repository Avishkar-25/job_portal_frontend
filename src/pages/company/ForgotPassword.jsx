...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/company/password/forgot-password/send-otp",
        {
          email: email.trim(),
        }
      );
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/company/password/forgot-password/verify-otp",
        {
          email,
          otp,
        }
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/company/password/forgot-password/reset",
        {
          email,
          newPassword,
          confirmPassword,
        ...
        <div className="card-body p-4 p-md-5">
          ...
          <div className="text-center">
            ...
            <p className="text-muted mb-4">
              {step === 1 &&
                "Enter your registered company email to receive an OTP."}
                ...
                <div className="d-flex">
                  ...
                  <div className="w-100">
                    ...
                    <input
                      ...
                      placeholder="Enter your registered company email"
                      value={email}
                      onChange={(e) =>
          ...
          <div className="text-center mt-4">
            <small className="text-muted">
              ...
              Secure Company Password Recovery
            </small>
          </div>
